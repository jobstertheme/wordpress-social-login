...
<div class="postbox">
	<div class="inside">
		<h3><?php __e("Welcome to WordPress Social Login", 'wordpress-social-login') ?></h3>

		<div style="padding:0 20px;">
			<p style="padding:0;margin:12px 0;">
				<?php __e('<b>WordPress Social Login</b> allows your website visitors and customers to register on using their existing social account ID, eliminating the need to fill out registration forms and remember usernames and passwords', 'wordpress-social-login') ?>.
			</p>
			<p style="padding:0;margin:0 0 12px;">
				<?php __e('<b>WordPress Social Login</b> come with a number of useful <b><a href="options-general.php?page=wordpress-social-login&wslp=components">Components</a></b> or add-ons that can be essential for your needs', 'wordpress-social-login') ?>.
			</p>
			<p style="padding:0;margin:0 0 12px;">
				<?php __e('If you are still new to things, we recommend that you read the <b><a href="http://miled.github.io/wordpress-social-login/documentation.html" target="_blank">WSL Documentation</a></b> and to make sure your server meet the minimum system requirements by running <b><a href="http://hybridauth.com/hawp4/wp-admin/options-general.php?page=wordpress-social-login&wslp=tools">WSL Diagnostics</a></b>', 'wordpress-social-login') ?>.
			</p>
			<p style="padding:0;margin:0 0 12px;">
				<?php __e('If you run into any issue, then refer to <b><a href="http://miled.github.io/wordpress-social-login/support.html" target="_blank">Help &amp; Support</a></b>', 'wordpress-social-login') ?>.
			</p>
		</div>
	</div>
</div>
...
<div class="postbox">
	<div class="inside">
		<h3><?php __e("Add more providers", 'wordpress-social-login') ?></h3>

		<div style="padding:0 20px;">
			<p style="padding:0;margin:0 0 12px;">
				<?php __e('We have enabled <b>Facebook</b>, <b>Google</b> and <b>Twitter</b> by default, however you may add even more. <b>Just Click</b> on the icons and we will guide you through', 'wordpress-social-login') ?>.
			</p>
			...
			<div style="width: 320px; padding: 10px; border: 1px solid #ddd; background-color: #fff;">
				<?php
					...
					{
						__e("Well! none left.", 'wordpress-social-login');
					}
				?>
			</div>
		</div>
...
<div class="postbox">
	<div class="inside">
		<h3><?php __e("Insights", 'wordpress-social-login') ?></h3>
			...
			<?php
				...
				if( $total_users && $total_users_wsl )
				{
					...
					?>
						...
						<h4 style="border-bottom:1px solid #ccc"><?php __e("Conversions", 'wordpress-social-login') ?></h4>
						<table width="90%">
							<tr>
								<td width="60%"><?php __e("WP users", 'wordpress-social-login') ?></td><td><?php echo $total_users; ?></td>
							</tr>
							<tr>
								<td><?php __e("WSL users", 'wordpress-social-login') ?></td><td><?php echo $total_users_wsl; ?></td>
							</tr>
							<tr>
								<td><?php __e("Conversions", 'wordpress-social-login') ?></td><td style="border-top:1px solid #ccc">+<b><?php echo number_format($users_conversion, 2, '.', ''); ?></b> %</td>
							</tr>
						</table>
						...
						?>
						<h4 style="border-bottom:1px solid #ccc"><?php __e("By provider", 'wordpress-social-login') ?></h4>
						<table width="90%">
							<?php
							...
							?>
							<tr>
								<td align="right">&nbsp;</td><td style="border-top:1px solid #ccc"><b><?php echo $total_profiles_wsl; ?></b> <?php __e("WSL profiles", 'wordpress-social-login') ?></td>
							</tr>
							<tr>
								<td align="right">&nbsp;</td><td><b><?php echo $total_users_wsl; ?></b> <?php __e("WSL users", 'wordpress-social-login') ?></td>
							</tr>
						</table>
						...
						?>
						<h4 style="border-bottom:1px solid #ccc"><?php __e("By gender", 'wordpress-social-login') ?></h4>
						<table width="90%">
							<?php
								foreach( $data as $item ){
						...
						?>
						<h4 style="border-bottom:1px solid #ccc"><?php __e("By age", 'wordpress-social-login') ?></h4>
						<table width="90%">
							<?php
								foreach( $data as $item ){
				...
				else
				{
					?>
						<p>
							<?php __e("There's no data yet", 'wordpress-social-login') ?>.
						</p>
					<?php
				}
			?>
