		...
		<div class="stuffbox" id="namediv">
			<h3>
				<label class="wp-neworks-label">
					<img alt="<?php echo $provider_name ?>" title="<?php echo $provider_name ?>" src="<?php echo $assets_base_url . '16x16/' . strtolower( $provider_id ) . '.png' ?>" style="vertical-align: top;width:16px;height:16px;" /> <?php _e( $provider_name, 'wordpress-social-login' ) ?>
				</label>
			</h3>
			<div class="inside">
				...
				>
					...
					<?php elseif ( $provider_new_app_link  ) : ?>
						<?php _e('<span style="color:#CB4B16;">Application <strong>ID</strong> and <strong>Secret</strong></span> (also sometimes referred as <span style="color:#CB4B16;">API</span> key and secret or <span style="color:#CB4B16;">Consumer</span> key and secret or <span style="color:#CB4B16;">Client</span> ID and secret) are what we call an application credentials', 'wordpress-social-login') ?>.
					...
					<div style="margin-left:40px;">
						<?php if ( $provider_new_app_link  ) : ?>
                            ...
                            <p><?php echo "<b>" . ++$setupsteps . "</b>." ?> <?php _e("Create a new application and fill out any required fields such as the application name, description, your domanin name, etc", 'wordpress-social-login') ?>.</p>

                            <p>
                                <?php echo "<b>" . ++$setupsteps . "</b>." ?> <?php _e("If asked about an authorized <b>Callback URL</b> for your application, you may provide this link", 'wordpress-social-login') ?>:
                                <br />
...
?>
    ...
    &nbsp; <a href="javascript:window.scrollTo(0, 0);"><?php _e("↑ Scroll back to top", 'wordpress-social-login') ?></a>
<?php
	// HOOKABLE:
